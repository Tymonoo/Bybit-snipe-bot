...
Add your bot to the channels above (or to a private group).
Use @junction_bot to forward messages from BWEnews and AstronomicaNews into one clean chat.
Add your sniping bot to that final chat (via BotFather setup).
